...
data = stats_df[stats_df['Over Score']>=0.5][['Player + Line','Over Score']].sort_values(by=['Over Score'], ascending=False) # data underlying bar plot in question
...
data = stats_df[stats_df['Under Score']>=0.5][['Player + Line','Under Score']].sort_values(by=['Under Score'], ascending=False) # data underlying bar plot in question
...
data = stats_df[stats_df['Over Score']>=0.6][['Over Score', 'Over Amount Score']].sort_values(by=['Over Score', 'Over Amount Score'])
...
# Heatmaps to display best picks #
data = stats_df[stats_df['Under Score']>=0.6][['Under Score', 'Under Amount Score']].sort_values(by=['Under Score', 'Under Amount Score'])
...
highest_overs = stats_df[stats_df['Over Score']>=0.6][['Player + Line','Over Score', 'Over Amount Score',
...
highest_unders = stats_df[stats_df['Under Score']>=0.6][['Player + Line','Under Score', 'Under Amount Score',
